...
const ACHIEVEMENT_DEFINITIONS = [
  ...
  // Streak achievements
  {
    ...
    description: '3 días consecutivos reportando',
    icon: '🔥',
    points: 30,
    condition: 'streak',
    threshold: 3
  },
  {
    id: 'streak_7',
    name: 'Semana Verde',
    description: '7 días consecutivos reportando',
    icon: '📅',
    points: 75,
    condition: 'streak',
    threshold: 7
  },
  {
    id: 'streak_14',
    name: 'Quincena Eco',
    description: '14 días consecutivos reportando',
    icon: '🌱',
    points: 150,
    condition: 'streak',
    threshold: 14
  },
  {
    id: 'streak_30',
    name: 'Mes Verde',
    description: '30 días consecutivos reportando',
    icon: '🌳',
    points: 300,
    condition: 'streak',
    threshold: 30
